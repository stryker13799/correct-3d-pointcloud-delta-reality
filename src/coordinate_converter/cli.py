...
from coordinate_converter.convert import VIEWER_WORLD_BASIS_CHANGE, convert_dataset
...
def _run_convert(args: argparse.Namespace) -> int:
    convert_dataset(VIEWER_WORLD_BASIS_CHANGE, args.input_dir, args.output_dir)
